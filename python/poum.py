...
class UnitManager:
    ...
    UNIT_ALIASES_FILE = "unit_aliases.txt"
    DISPLAY_SYMBOLS_FILE = "display_symbols.txt"
    ...
    @staticmethod
    def convert(from_unit: Unit, to_unit: Unit, value: Decimal) -> Decimal:
    ...
    def _load_from_json(self):
        units = []
        try:
            with open("uom.json", 'r') as stream:
